                     ...
                     <form action="<?php echo URLROOT; ?>/parents/addchild" method="post" enctype="multipart/form-data">
                            <div class="container">
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="text" name="name" size="30" placeholder="Enter name" class="input-y <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['name']; ?>" required><br>
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="date" id="dob" name="dob" size="30" placeholder="Enter birthday" required class="input-x <?php echo (!empty($data['dob_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['dob']; ?>">
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="school" name="school" size="30" placeholder="Enter school" required class="input-y <?php echo (!empty($data['school_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['school']; ?>"> <br>
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="text" name="school_address" size="30" placeholder="Enter school address" required class="input-y <?php echo (!empty($data['school_address_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['school_address']; ?>"> <br>
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="text" name="distance_to_school" size="30" placeholder="Enter distance to school in km" required class="input-y <?php echo (!empty($data['distance_to_school_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['distance_to_school']; ?>"> <br>
                                   ...
                                   <div class="field">
                                          ...
                                          <input type="file" name="child_image" placeholder="Upload a profile picture of the child" required class="input-y <?php echo (!empty($data['child_image'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['child_image']; ?>"> <br>
