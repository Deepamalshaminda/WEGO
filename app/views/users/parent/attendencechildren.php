...
<div id="Parentrequests" class="tabcontent">
  <div class="friend-list">
    ...
    <div class="friend-card">
      ...
      <button class="details-button"><a href="<?php echo URLROOT?>/Markattendance/markattendance"> Mark attendance</a></button>
    ...
    <div class="friend-card">
      ...
      <br>
      <div class="friend-actions">
      <button class="details-button">Mark attendance</button>
