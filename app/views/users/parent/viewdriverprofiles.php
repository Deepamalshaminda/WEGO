...
<div class="wrapper">
    ...
    <div class="right">
        <div class="info">
            ...
            <div class="info_data">
                 <div class="data">
                    <h4>Name : Kevin Maxwell</h4>
                    <br>
                    <h4>Age : 34 yrs</h4>
                    <br>
                    <h4>Address : 16/B, Nugegoda</h4>
                    <br>
                    <h4>Nic number : 996574503v</h4>
                    <br>
                    <h4>DL number : B-89706</h4>
                    <br>
                    <h4>Vehicle types : Bus,Car,Van</h4>
