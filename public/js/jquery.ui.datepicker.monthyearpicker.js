...
(function ($, undefined) {
  ...
  $.datepicker._updateDatepicker_MonthYearPicker =
  ...
  $.extend($.datepicker, {
    ...
    _updateDatepicker: function (inst) {
      ...
      inst.dpDiv.find(".ui-datepicker-calendar").css("display", "none");

      inst.dpDiv
        .children("table.ui-datepicker-calendar")
        .after(this._generateExtraHTML_MonthYearPicker(inst));
    ...
    _generateMonthPickerHTML_MonthYearPicker: function (
      inst,
      minDate,
      maxDate,
      drawMonth,
      ...
      for (var month = 0; month < 12; ) {
        ...
        monthPicker +=
          ...
          (unselectable
            ...
            : "") + // highlight unselectable months
          (month == drawMonth ? " ui-datepicker-today" : "") +
          '"' +
          (unselectable
            ? ""
            : " onclick=\"jQuery.datepicker._pickMonthYear_MonthYearPicker('#" +
              inst.id +
              "', " +
              month +
              ", 'M');return false;\"") +
    ...
    _generateExtraHTML_MonthYearPicker: function (inst) {
      ...
      var monthPicker = this._generateMonthPickerHTML_MonthYearPicker(
        inst,
        minDate,
        maxDate,
        drawMonth,
      ...
      return (
        '<div class="ui-datepicker-select-month" style="display: none">' +
        monthPicker +
        "</div>" +
    ...
    _pickMonthYear_MonthYearPicker: function (id, valueMY, period) {
      var dummySelect = $("<select/>").append(
        new Option(valueMY, valueMY, true, true)
      );
      ...
      switch (screen) {
        case 2:
          ...
          var _advanceYear_MYP = function (diff) {
            ...
            if (minDate || maxDate) {
              ...
              var monthPicker = self._generateMonthPickerHTML_MonthYearPicker(
                inst,
                minDate,
                maxDate,
                drawMonth,
              ...
              inst.dpDiv
                .children(".ui-datepicker-select-month")
                .html(monthPicker);
            }
          ...
          dpTitle.html(
            '<a href="#" class="ui-datepicker-yearpicker" onclick="jQuery.datepicker._toggleDisplay_MonthYearPicker(\'#' +
              inst.id +
              "', 3);return false;\">" +
              drawYear +
              "</a>"
          ...
          var dpMonthSelector = inst.dpDiv.find(
            ".ui-datepicker-select-month table"
          );
        ...
        case 3:
          ...
          $.backToActualMonth = function () {
            ...
            $.datepicker._pickMonthYear_MonthYearPicker(
              "#" + inst.id,
              drawMonth,
              "M"
            );
          ...
          var _updateYearPicker_MYP = function (year) {
            ...
            for (var i = 1; i <= 12; i++) {
              ...
              yearPicker +=
                ...
                ">" + // actions
                (unselectable
                  ? '<span class="ui-state-default">' + year + "</span>"
                  : '<a class="ui-state-default ' +
                    //(month == drawMonth ? ' ui-state-highlight' : '') +
          ...
          var dpYearSelector = inst.dpDiv.find(
            ".ui-datepicker-select-year table"
          );
